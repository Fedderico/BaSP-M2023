...
birthdayInput.addEventListener("blur", function () {
  ...
  if (
    ...
    var ageDiff = today.getFullYear() - birthdayDate.getFullYear();
...
//   ) {
//     birthdayInput.style.borderColor = "red";
//     alert("Fecha no válida. Debe tener formato MM/DD/YYYY.");
//   } else {
//     var birthdayDate = new Date(birthdayValue);
//     var today = new Date();
...
form.addEventListener("submit", (event) => {
  ...
  const queryParams = `?name=${nameInput.value}&lastName=${lnameInput.value}&dni=${dniInput.value}&dob=${birthdayInput.value}&phone=${phoneInput.value}&address=${addressInput.value}&city=${cityInput.value}&zip=${postalCodeInput.value}&email=${emailInput.value}&password=${passwordInput.value}`;

  const paramsUrl = url + queryParams;
